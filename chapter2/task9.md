...
请读者到`http://https://github.com/liupengyuan/liupengyuan.github.io/tree/master/chapter2/data/`下载文本文件`语料.zip`，并将文件解压，保存到目录:`d:\temp\`下，文件名为：`语料.txt`。解压时间较长，请耐心等待（好在只解压一次）。   
